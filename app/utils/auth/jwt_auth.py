...
class JWTAuth:
    ...
    def authorize_user_for_project(self, f: callable, token: str, *args: tuple, **kwargs: dict) -> Response | Any:
    ...
    def handle_expired_access_token(self, f: callable, *args: tuple, **kwargs: dict) -> Response:
        ...
        if new_access_token:
            try:
                return self.authorize_user_for_project(f, new_access_token, *args, **kwargs)
